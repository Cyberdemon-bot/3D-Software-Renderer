...
def compile_renderer():
    ...
    tests = [
        ...
        ("render_meshes_serial",   lambda: render_meshes(dummy_mesh_list, dummy_pivot_list, dummy_pivot_list, dummy_rot_list, dummy_tex_list, dummy_uv_list, dummy_visible_flag, dummy_removed_flag, dummy_light_active_flag, dummy_light_data_list, db, view, proj, width, height, dummy_vb, dummy_fb, dummy_zb, dummy_ob, thread_buffers, False, True)),
        ("render_meshes_parallel", lambda: render_meshes(dummy_mesh_list, dummy_pivot_list, dummy_pivot_list, dummy_rot_list, dummy_tex_list, dummy_uv_list, dummy_visible_flag, dummy_removed_flag, dummy_light_active_flag, dummy_light_data_list, db, view, proj, width, height, dummy_vb, dummy_fb, dummy_zb, dummy_ob, thread_buffers, True, True)),
    ]
