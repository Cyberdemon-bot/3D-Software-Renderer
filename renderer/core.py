...
class Renderer:
    ...
    def render_meshes(self):
        ...
        res = render_meshes(
            ...
            self.mesh_visible_flag, self.removed_flag, self.light_active_flag, self.light_shadow_list, self.light_diffuse_list, 
            view_mat, self.proj_mat, self.width, self.height, 
            self.vertices_buffer, self.framebuffer, self.z_buffer, self.object_buffer, 
